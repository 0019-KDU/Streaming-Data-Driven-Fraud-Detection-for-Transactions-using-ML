  ...
  return (
    <div 
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = `0 12px 24px ${getAccountTypeColor(account.account_type)}40`;
      }}
      onMouseLeave={(e) => {
  ...
  const fetchCustomerData = async () => {
    try {
      ...
      try {
        ...
        const accountsRes = await api.get(`/accounts/customer/${customerId}`);
        ...
        // Don't fail the whole page if accounts fail
        setAccounts([]);
      }
            ...
            <div className="accounts-grid" style={{ 
              ...
              {accounts.length === 0 ? (
                <div style={{ 
                  ...
                  <p style={{ fontSize: '0.9rem', margin: 0 }}>Check if accounts were generated for this customer.</p>
                </div>
              ) : (
